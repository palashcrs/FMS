...
UNIQUE (EDGEPAY_RULE_TYPE_ID,EDGEPAY_EMAIL),
UNIQUE (EDGEPAY_RULE_TYPE_ID,EDGEPAY_CARD_NO),
UNIQUE (EDGEPAY_RULE_TYPE_ID,EDGEPAY_IP),
UNIQUE (EDGEPAY_RULE_TYPE_ID,EDGEPAY_STR_ADDR),
UNIQUE (EDGEPAY_RULE_TYPE_ID,EDGEPAY_WORD),
UNIQUE (EDGEPAY_RULE_TYPE_ID,EDGEPAY_LIMIT_CARD,EDGEPAY_TIME_PERIOD),
UNIQUE (EDGEPAY_RULE_TYPE_ID,EDGEPAY_LIMIT_IP,EDGEPAY_TIME_PERIOD),
UNIQUE (EDGEPAY_RULE_TYPE_ID,EDGEPAY_LIMIT_MAX_AMT),
UNIQUE (EDGEPAY_RULE_TYPE_ID,EDGEPAY_AVS_ZIP,EDGEPAY_AVS_RESULT),
UNIQUE (EDGEPAY_RULE_TYPE_ID,EDGEPAY_AVS_STR_ADDR,EDGEPAY_AVS_RESULT),
UNIQUE (EDGEPAY_RULE_TYPE_ID,EDGEPAY_AVS_CITY,EDGEPAY_AVS_RESULT),
UNIQUE (EDGEPAY_RULE_TYPE_ID,EDGEPAY_AVS_STATE,EDGEPAY_AVS_RESULT),
UNIQUE (EDGEPAY_RULE_TYPE_ID,EDGEPAY_GEOLOC_IP),
UNIQUE (EDGEPAY_RULE_TYPE_ID,EDGEPAY_DEVICE_ID)
);
