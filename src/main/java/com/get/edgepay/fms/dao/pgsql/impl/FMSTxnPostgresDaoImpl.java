...
public class FMSTxnPostgresDaoImpl implements FMSTxnPostgresDao {
	...
	private static final String UPSERT_SQL = "INSERT INTO EDGEPAY_FMS_TRANSACTION " 
			 + " ( "
			 + "EDGEPAY_TXN_ID, "
			 + "EDGEPAY_TXN_TYPE, "
			 + "EDGEPAY_TXN_TOTAL_AMT, "
			 + "EDGEPAY_TXN_STATUS, "
			 + "EDGEPAY_FMS_TXN_STATUS, "
			 + "EDGEPAY_TXN_EMAIL, "
			 + "EDGEPAY_TXN_CARD_NO, "
			 + "EDGEPAY_TXN_IP, "
			 + "EDGEPAY_TXN_STR_ADDR, "
			 + "EDGEPAY_TXN_CUSTNAME, "
			 + "EDGEPAY_TXN_AVS_ZIP, "
			 + "EDGEPAY_TXN_AVS_STR_ADDR, "
			 + "EDGEPAY_TXN_AVS_CITY, "
			 + "EDGEPAY_TXN_AVS_STATE, "
			 + "EDGEPAY_TXN_GEOLOC_IP, "
			 + "EDGEPAY_TXN_DEVICE_ID, "
			 + "EDGEPAY_TXN_NOTES, "
			 + "EDGEPAY_TXN_VIOLATED_RULES, "
			 + "EDGEPAY_TXN_CREATED_BY, "
			 + "EDGEPAY_TXN_CREATION_TS, "
			 + "EDGEPAY_TXN_UPDATED_BY, "
			 + "EDGEPAY_TXN_UPDATED_TS"
			 + ") "
			 + " VALUES"
			 + "("
			 + ":edgePayTxnId, "
			 ...
			 + ":updatedTs"
			 + ") "
			 + "ON CONFLICT(EDGEPAY_TXN_ID) DO UPDATE "
			 + "SET "
			 + "EDGEPAY_TXN_STATUS=:edgePayTxnStatus, "
			 + "EDGEPAY_FMS_TXN_STATUS=:fmsTxnStatus, "
			 + "EDGEPAY_TXN_NOTES=:notes, "
			 + "EDGEPAY_TXN_UPDATED_BY=:updatedBy, "
			 + "EDGEPAY_TXN_UPDATED_TS=:updatedTs";
